...
class ProjectMember(Base):
    ...
    input_month = Column(DECIMAL(5, 2), default=0, comment="投入月份")
    input_days = Column(Integer, default=0, comment="投入天数")
    bonus = Column(DECIMAL(10, 2), default=0, comment="开发奖金")
    product_bonus = Column(DECIMAL(10, 2), default=0, comment="产品提成")
    deleted_at = Column(DateTime, nullable=True)
    created_at = Column(DateTime, default=datetime.datetime.utcnow)
